...
if web=="Home":
    ...
    slt.subheader(":blue[Developed-by:] VIJAY")

# States and Routes page setting
if web=='📍States and Routes':
    S = slt.selectbox("Lists of States", ["Kerala", "Adhra Pradesh", "Chandigarh", "Goa", "Rajastan", 
    ...
    if S == "Kerala":
        ...
        def type_and_fare(bus_type, fare_range):
            conn = pymysql.connect(host="localhost", user="root", password="rostervii123", database="PROJECTS")
